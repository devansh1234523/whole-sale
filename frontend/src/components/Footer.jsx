            ...
            <div className="footer-column">
              ...
              <address className="footer-contact">
                <p>
                  ...
                  <a
                    href="https://maps.google.com/?q=123+Business+Avenue,+Suite+500,+New+York,+NY+10001"
                    target="_blank"
                ...
                <p>
                  ...
                  <a
                    href="mailto:info@wholesaleflow.com?subject=Inquiry%20about%20WholesaleFlow"
                    className="footer-link"
                    title="Send us an email"
                  >
                    info@wholesaleflow.com
                  </a>
                </p>
                <p><i className="fas fa-clock">🕒</i> Monday - Friday: 9:00 AM - 5:00 PM EST</p>
              </address>
            </div>
          </div>
        </div>
